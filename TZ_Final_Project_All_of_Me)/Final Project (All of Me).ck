...
hi => now;
    while ( hi.recv( msg ) ){ 
        if( msg.isButtonDown() ){ 
            ...
            if (msg.which == 20) 0. => s1.gain;
            if (msg.which == 31) 0. => s2.gain;
            if (msg.which == 26) 0. => s3.gain;
            if (msg.which == 32) 0. => s4.gain;
            if (msg.which == 8) 0. => s5.gain;
            if (msg.which == 21) 0. => s6.gain;
            if (msg.which == 34) 0. => s7.gain;
            if (msg.which == 23) 0. => s8.gain;
            if (msg.which == 35) 0. => s9.gain;
            if (msg.which == 28) 0. => s10.gain;
            if (msg.which == 36) 0. => s11.gain;
            if (msg.which == 24) 0. => s12.gain;
            if (msg.which == 12) 0. => s13.gain;
            if (msg.which == 38) 0. => s14.gain;
            if (msg.which == 18) 0. => s15.gain;
            if (msg.which == 39) 0. => s16.gain;
            if (msg.which == 19) 0. => s17.gain;
            if (msg.which == 47) 0. => s18.gain;
            if (msg.which == 46) 0. => s19.gain;
            if (msg.which == 48) 0. => s20.gain;
        }
    }
} 
